...
<div id="middle">
	<form name="info" id="info" action="page_listMusicsNew.action" method="post" style="width:695px;height:100%">
	<input type="hidden" name="pageNo" id="pageNo" value="${pageNo}"/>
	<div id="list">
		 <div class="nav">
		 	<div class="nav1">当前位置: 主页 > 最新歌曲  </div>
		 	<div class="nav2">　　　
		 	    音乐名称：
...
<script language="javascript" type="text/javascript">
	function serch()
	{
	   document.info.action="page_listMusicsNew.action";
