			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">音乐类型管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listMusicTypes.action" target="MainFrame">音乐类型查询</a></li>
					  <li><a href="Admin_addMusicTypeShow.action" target="MainFrame">新增音乐类型</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">音乐信息管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listMusics.action" target="MainFrame">音乐查询</a></li>
					  <li><a href="Admin_addMusicShow.action" target="MainFrame">新增音乐</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">音乐订单管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listOrderss.action" target="MainFrame">音乐订单查询</a></li>
					</ul>
				  </div>
