...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("paramsMusic.lrc_name");
    ...
    //window.parent.document.getElementById("paramsFiles.files_name").value=filenameGBK;
