...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("paramsMusic.music_name2");
    ...
    window.parent.document.getElementById("paramsMusic.music_name").value=filenameGBK;
    //window.parent.document.getElementById("paramsFiles.files_size").value=filelength;
  }
  else if(flag=='no')
  {
    window.parent.document.getElementById("op").style.display="none";
