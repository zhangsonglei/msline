...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">音乐订单管理&gt;&gt;音乐订单查询</span>
</div>
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="" align="right">
            音乐名称：
      <input type="text" name="paramsMusic.music_name" value="${paramsMusic.music_name}" class="inputstyle" Style="width:100px;"/>&nbsp;
            购买用户：
      <input type="text" name="paramsMusic.real_name" value="${paramsMusic.real_name}" class="inputstyle" Style="width:100px;"/>&nbsp;&nbsp;
